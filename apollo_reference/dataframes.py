...
SPECIES_REFERENCE_TSV = os.path.join(ospdn(ospdn(__file__)),"data","supported-reference-species.tsv")
# reformatted representation of SPECIES_REFERENCE_TSV, generated by apollo-reference
ASSEMBLY_REFERENCE_TSV = os.path.join(ospdn(ospdn(__file__)),"data","reference_assembly_data.tsv")
# generated by apollo-reference
FASTQ_REFERENCE_TSV = os.path.join(ospdn(ospdn(__file__)),"data","accession2SRR.tsv")
